...
missing_train_icon.icon = "__cybersyn_sal__/graphics/icons/missing-train.png"
...
lost_train_icon.icon = "__cybersyn_sal__/graphics/icons/lost-train.png"
...
nonempty_train_icon.icon = "__cybersyn_sal__/graphics/icons/nonempty-train.png"
