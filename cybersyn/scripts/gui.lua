...
local function set_visibility(main_window, selected_index)
	...
	second_settings.is_strict.visible = is_station
				...
				{type="flow", name="vflow", direction="vertical", style_mods={horizontal_align="left"}, children={
					...
					{type="flow", name="bottom", direction="horizontal", style_mods={vertical_align="top"}, children={
						...
						{type="flow", name="second", direction="vertical", style_mods={horizontal_align="left", right_margin=8}, children={
							{type="checkbox", name="is_strict", state=setting(bits, SETTING_STRICT_LAYOUT), handler=handle_setting, tags={id=comb.unit_number, bit=SETTING_STRICT_LAYOUT}, tooltip={"cybersyn-gui.enable-strict-allow-list-tooltip"}, caption={"cybersyn-gui.enable-strict-allow-list-description"}},
